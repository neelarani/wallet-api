...
exports.registerUser = (0, shared_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const user = (yield service.registerUser(req.body));
    (0, shared_1.setAuthCookie)(res, (0, shared_1.createUserTokens)(user));
...
exports.updatePassword = (0, shared_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    (0, shared_1.sendResponse)(res, {
        success: true,
        status: shared_1.HTTP_CODE.OK,
        message: 'Password updated!',
        data: yield service.updatePassword(req.user, req.body),
    });
}));
...
exports.getMyProfile = (0, shared_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const user = yield service.getMyProfile(req.user);
    (0, shared_1.sendResponse)(res, {
        success: true,
        status: shared_1.HTTP_CODE.OK,
