...
exports.withdraw = (0, shared_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    (0, shared_1.sendResponse)(res, {
        ...
        data: yield service.withdraw(req.body, req.user),
    });
}));
exports.sendMoney = (0, shared_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    (0, shared_1.sendResponse)(res, {
        ...
        data: yield service.sendMoney(req.body, req.user),
    });
}));
exports.transactionHistory = (0, shared_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    (0, shared_1.sendResponse)(res, Object.assign({ success: true, status: shared_1.HTTP_CODE.OK, message: "Transaction History retrieved successfully" }, (yield service.transactionHistory(req.query, req.user))));
}));
